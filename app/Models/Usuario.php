    ...
    static function getUsuariosGestion($filtros=[]){
        ...
        ->select('US.ID_USUARIO','US.USUARIO','US.CORREO',
            ...
            DB::Raw("CONCAT(US.NOMBRES ,' ',US.APELLIDO_PATERNO,' ',US.APELLIDO_MATERNO) 
                AS NOMBRES_COMPLETOS"),'US.PERFIL','ROL.NOMBRE AS ROL_USUARIO','ROL.ID_ROL','ES.ID_ESPECIALIDAD', 
            DB::Raw("CASE WHEN ROL.ID_ROL=1 THEN '' ELSE ES.NOMBRE END AS ESPECIALIDAD_USUARIO"), 'US.ESTADO AS FLG_ACTIVO')    

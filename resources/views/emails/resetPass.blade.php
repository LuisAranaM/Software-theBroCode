...
<body paddingwidth="0" paddingheight="0" bgcolor="#d1d3d4"  style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
  ...
  <tbody>
    ...
    <tr><center>
      <img src="http://rubrik.inf.pucp.edu.pe/img/logo2.png" alt="Logo" title="Logo" style="width:400px"></td>
    </center></tr>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              ...
                              <br>
                              <p>Nos solicitaste ayuda para recuperar tu contraseña RubriK. A continuación te brindaremos los pasos a seguir:</p>
                            </div>
                          </div>
                        </td>
                      </tr>
      ...
      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">Instrucciones</h2>
                              <br>
                              <p>1) Ingresar a RubriK con tus nuevas credenciales<br>
                                Usuario: {{$usuario}} Correo: {{$email}}<br>
                              	Nueva Contraseña: {{$password}}<br>
                                2) Personalizar tu nueva contraseña en la opción de 'Cambiar Contraseña'
                              </p>
                              <br><br>

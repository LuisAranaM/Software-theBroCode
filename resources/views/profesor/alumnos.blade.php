					...
					<div class="table-responsive">
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody class="text-left">
								<tr class="even pointer" id="CargarCurso">
								...
								<tr class="even pointer">
									...
									<td class="pText" style="background-color: white; padding-top: 12px; color: #72777a"><a>Subir proyecto<i class="fa fa-upload" style="padding-left: 5px"></i></a></td>  
